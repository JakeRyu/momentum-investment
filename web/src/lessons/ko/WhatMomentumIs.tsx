  ...
  return (
    <>
      ...
      <p>
        ...
        있지 않다&rsquo;로 읽습니다. 이 전략에서 중요한 것은 점수가
        플러스인지 마이너스인지, 그리고 다른 자산보다 높은지 낮은지입니다.
        따라서 0.62라는 숫자 자체에 특별한 의미가 있는 것은 아닙니다. 같은
      ...
      <p>
        빠르게 반응하면 하락에서 일찍 빠져나올 수 있지만 잘못된 신호도
        많아집니다. 느리게 반응하면 잘못된 신호는 줄어들지만 움직임이
        늦어집니다. 어떤 전략이 어느 방식을 쓰는지는 아래 표에 정리되어
        있습니다.
      </p>
